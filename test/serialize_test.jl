...
@testset "serialize" begin
    @testset "MVHistory" begin
        ...
        push!(expected, :e, 1, OneClassActiveLearning.ConfusionMatrix(1,1,1,1))
        push!(expected, :e, 2, OneClassActiveLearning.ConfusionMatrix(2,2,2,2))
    ...
    @testset "Result" begin
       ...
       push!(al_history, :query_label, 1, :inlier)
       push!(al_history, :query_label, 2, :outlier)
       push!(al_history, :query, 1, ones(2, 1))
       push!(al_history, :query, 2, zeros(2, 1))
