...
experiment = Dict{Symbol, Any}(
    ...
    :data_file => DATA_FILE,
    :data_set_name => "Dummy",
    :output_file => joinpath(@__DIR__, "example_pool_qs.json"),
    :log_dir => joinpath(@__DIR__, "example_pool_qs.log"),
    ...
    :query_strategy => Dict(:type => :IterativeBatchQs,
                            :param => Dict{Symbol, Any}(
                                        :k => batch_size,
                                        ...
                                        :λ_div => λ_div,
                                        :λ_rep => λ_rep,
                                        :SequentialStrategy => Dict(:type => :HighConfidencePQs, :param => Dict{Symbol, Any}())
                                    )),
