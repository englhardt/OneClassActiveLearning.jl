...
function ask_oracle(oracle::QuerySynthesisGMMOracle, query_object::Array{T, 2})::Vector{Symbol} where T <: Real
    return ifelse.(Distributions.pdf(Distributions.MixtureModel(oracle.gmm), query_object) .< 0.1, :outlier, :inlier)
end
